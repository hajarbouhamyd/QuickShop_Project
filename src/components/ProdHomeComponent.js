...
export default class ProdHomeComponent extends Component <props> {
    static propTypes = {
                ...
                {this.props.items.map((item, index) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <TouchableOpacity style={{flex: 1.5}} onPress={() => this.props.navigation.navigate(
                                "Details",
                            { itemId:item.id,proName:item.designation,proPrice:item.prix,
                                proImage:item.imageUrl,overview:item.description,vote:item.rating, prodItem: item})}>
                                <Image
                                    style={styles.image}
                                    resizeMode={'stretch'}
