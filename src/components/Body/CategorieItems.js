                ...
                {this.props.items.map((item, index) => {
                    ...
                    return (
                        ...
                        <View key={index}
                              style={{flex:1}}
                        >
                            {this.props.catName === item.categorie ? (
                              {/*  <View>
                            <Image
                                style={styles.image}
                                resizeMode={'stretch'}
                            ...
                            >
                                ...
                                <View key={index}
                                      style={{flex:1, flexDirection:'rhadow'}}
                                >
                                    ...
                                    {/*    //     proImage:item.imageUrl,overview:item.description,vote:item.rating})}*/}
                                    {/*>*/}
                                    <Image
                                        style={styles.image}
                                        resizeMode={'stretch'}
                                    ...
                                    <TouchableOpacity  style={{flex:2}}>
                                        ...
                                        <View style={{flex:1,}}>
                                            <Text style={[styles.textStyle,{fontSize: 20, marginTop:10}]}>{item.designation}</Text>
                                            <Text style={[styles.textStyle,{fontSize: 17}]}> Price: ${item.prix}</Text>
